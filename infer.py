...
class CRATEFeat(nn.Module):
    def __init__(self,  feat_dim, pretrained_path = None, depth = 12, crate_arch = 'base', patch_size = 16, device = 'cuda'):
        super().__init__()
        if crate_arch == 'small':
        ...
        #self.model = CRATE_tiny(num_classes=10) 
